...
const EXPORT_MODAL_BODY =
  'The export job is running in the background. Stay on the page to have it download automatically when it\'s done. If you leave the page you will need to download it from the runs tab.';

export function CsvBuilderExportModal({
  visible,
  onClose,
  phase,
  errorMessage,
