  ...
  return (
    <Card variant="card">
      ...
      <Text className="text-gray-400 font-instrument text-sm mb-4 leading-5">
        Link rows in imported records, then run state matching, website verification, and contact enrichment when
        ready. Progress for normalize, linking, verification, enrichment, and queue is in the dials above.
      </Text>
