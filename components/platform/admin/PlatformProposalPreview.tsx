...
import { ProposalAddOnCard } from '@/components/platform/contract/ProposalAddOnCard';
import { ProposalPlanCard } from '@/components/platform/contract/ProposalPlanCard';
import { getSelectedProposalAddOns } from '@/lib/platform/contract/proposalAddOns';
import { getProposalPlanPreset, PROPOSAL_CONSULTING_TIME } from '@/lib/platform/contract/proposalPlans';
