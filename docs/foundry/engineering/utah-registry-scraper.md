...
| Playwright runner + CLI | [`workers/utah-scraper/`](../../../workers/utah-scraper/) |
...
From repo root (or `workers/utah-scraper`):

```bash
cd workers/utah-scraper
npm install
