...
export const DEFAULT_SAVED_LIST_COLUMNS: LeadsColumnDef[] = [
  { id: 'person-email', sourceType: 'person', sourceLabel: 'Lead info', fieldKey: 'email', label: 'Email', visible: true, width: 260 },
  { id: 'person-name', sourceType: 'person', sourceLabel: 'Lead info', fieldKey: 'display_name', label: 'Name', visible: true, width: 180 },
