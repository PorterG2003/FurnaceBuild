...
test('rollupDailyToIsoWeeks sums sent/replied/positive/bounce by ISO week', () => {
  const rows = rollupDailyToIsoWeeks([
    { date: '2026-08-10', sent: 10, replied: 1, positiveReply: 1, bounce: 0 },
    { date: '2026-08-11', sent: 5, replied: 2, positiveReply: 0, bounce: 1 },
    { date: '2026-08-17', sent: 3, replied: 0, positiveReply: 0, bounce: 0 },
  ]);
  assert.deepEqual(rows, [
    { weekStart: '2026-08-10', sent: 15, replied: 3, positiveReply: 1, bounce: 1 },
    { weekStart: '2026-08-17', sent: 3, replied: 0, positiveReply: 0, bounce: 0 },
  ]);
});
