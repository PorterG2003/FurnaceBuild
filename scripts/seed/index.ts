...
Scenarios: dev-default, demo-hub, campaign-smoke, bucket-insights-smoke, ooo-mixed-inbox, smart-handling-flow, categorizer-flow, platform-invite-preview, replace-lead-attach, minimal (see README).
