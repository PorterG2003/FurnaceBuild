...
Scenarios: dev-default, demo-hub, campaign-smoke, copy-structure-metrics, bucket-insights-smoke, ooo-mixed-inbox, smart-handling-flow, categorizer-flow, platform-invite-preview, replace-lead-attach, minimal (see README).
