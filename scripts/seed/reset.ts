...
Options:
  --scope=<name>    campaign-smoke | ooo-mixed-inbox | dev-default | demo-hub | smart-handling-flow | replace-lead-attach | all
  --scope <name>
...
Notes:
  ...
  Scope all uses known seed campaign ids for all built-in scenarios.
`);
}
