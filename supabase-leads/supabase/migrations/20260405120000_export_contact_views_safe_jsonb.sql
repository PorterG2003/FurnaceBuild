-- Fix export contact views if a prior migration created versions that error on bad
-- decision_metadata (non-array JSON, invalid total_score). Idempotent CREATE OR REPLACE.
...
CREATE OR REPLACE VIEW export_owner_contact_enrichment_flat
