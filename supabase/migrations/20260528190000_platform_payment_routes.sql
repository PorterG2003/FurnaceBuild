-- ============================================
-- Platform invite payment routes and fee audit fields
-- ============================================

ALTER TABLE public.platform_invitations
  ADD COLUMN IF NOT EXISTS selected_payment_route TEXT,
  ADD COLUMN IF NOT EXISTS selected_payment_route_fee_cents INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS selected_payment_subtotal_cents INTEGER,
  ADD COLUMN IF NOT EXISTS selected_payment_total_cents INTEGER;

ALTER TABLE public.platform_invitations
  DROP CONSTRAINT IF EXISTS platform_invitations_selected_payment_route_check;

ALTER TABLE public.platform_invitations
  ADD CONSTRAINT platform_invitations_selected_payment_route_check
  CHECK (
    selected_payment_route IS NULL
    OR selected_payment_route IN ('card', 'ach')
  );

ALTER TABLE public.platform_invitations
  DROP CONSTRAINT IF EXISTS platform_invitations_selected_payment_route_fee_cents_check;

ALTER TABLE public.platform_invitations
  ADD CONSTRAINT platform_invitations_selected_payment_route_fee_cents_check
  CHECK (selected_payment_route_fee_cents >= 0);

ALTER TABLE public.platform_invitations
  DROP CONSTRAINT IF EXISTS platform_invitations_selected_payment_subtotal_cents_check;

ALTER TABLE public.platform_invitations
  ADD CONSTRAINT platform_invitations_selected_payment_subtotal_cents_check
  CHECK (
    selected_payment_subtotal_cents IS NULL
    OR selected_payment_subtotal_cents >= 0
  );

ALTER TABLE public.platform_invitations
  DROP CONSTRAINT IF EXISTS platform_invitations_selected_payment_total_cents_check;

ALTER TABLE public.platform_invitations
  ADD CONSTRAINT platform_invitations_selected_payment_total_cents_check
  CHECK (
    selected_payment_total_cents IS NULL
    OR selected_payment_total_cents >= 0
  );
