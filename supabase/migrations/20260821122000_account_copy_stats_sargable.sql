-- Sargable UTC range + events.account_id for account_copy_stats.
...
COMMENT ON FUNCTION public.account_copy_stats(uuid, date, date, uuid[], text, text) IS
  'Account-scoped copy-piece performance via message_jobs.copy_rendering_id; ooo_replied includes out_of_office and Auto Reply threads. Event range is sargable UTC timestamps.';
